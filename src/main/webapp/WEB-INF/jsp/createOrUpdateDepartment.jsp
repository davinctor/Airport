...
<div class="page-body container-fluid text-center">
  ...
  <div class="row">
    <div class="col-md-offset-3 col-md-6">
      <form:form action="${requestScope['javax.servlet.forward.request_uri']}" method="post" modelAttribute="department"
        ...
        <div class="form-group ${(not empty scheduleFromError) ? 'has-error' : ''}">
          ...
          <div class="col-md-6">
            <div class="input-group datetimepicker">
              <input id="time-from" name="scheduleFromTime" class="form-control" placeholder="Время начала работы" type="text"
                     value="${scheduleFrom}">
        ...
        <div class="form-group ${(not empty scheduleToError) ? 'has-error' : ''}">
          ...
          <div class="col-md-6">
            <div class="input-group datetimepicker">
              <input id="time-to" name="scheduleToTime" class="form-control" placeholder="Время окончания работы" type="text"
                     value="${scheduleTo}">
            	<span class="input-group-addon">
                	<span class="glyphicon glyphicon-calendar"></span>
              	</span>
        ...
        <div class="form-group ${(not empty breakFromError) ? 'has-error' : ''}">
          ...
          <div class="col-md-6">
            <div class="input-group datetimepicker">
              <input id="break-from" name="breakFromTime" class="form-control" placeholder="Время начала перерыва" type="text"
                      value="${breakFrom}">
            	<span class="input-group-addon">
                	<span class="glyphicon glyphicon-calendar"></span>
              	</span>
        ...
        <div class="form-group ${(not empty breakToError) ? 'has-error' : ''}">
          ...
          <div class="col-md-6">
            <div class="input-group datetimepicker">
              <input id="break-to" name="breakToTime" class="form-control" placeholder="Время окончания перерыва" type="text"
                     value="${breakTo}">
            	<span class="input-group-addon">
                	<span class="glyphicon glyphicon-calendar"></span>
              	</span>
