...
<div class="page-body container-fluid text-center">
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            <form:form action="/user/${user.id == 0 ? 'new' : 'edit/'.concat(user.id)}" method="post" modelAttribute="user"
                ...
                <div class="form-group ${not empty staffError ? 'has-error' : ''}">
                    ...
                    <div class="staff-profile" id="staff">
                        <c:choose>
                                        ...
                                        <c:forEach items="${departments}" var="department">
                                            <option value="department-${department.id}"
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${user.staff.department.id == department.id}">
                                                             selected
                            ...
                            <c:otherwise>
                                <div class="col-md-7">
                                    <div class="well ${not empty staffError ? 'text-danger': ''}">
                                            ${emptyDepartments}
                                    </div>
                                </div>
                            </c:otherwise>
